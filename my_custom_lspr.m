...
% my_custom_lspr.m
%
% Model exported on Nov 3 2020, 00:58 by COMSOL 5.5.0.359.
...
model.component('comp1').geom('geom1').feature('r1').set('size', {'d+gap+gold_surf_wd' '1'});
model.component('comp1').geom('geom1').feature('r1').setIndex('size', '(d*3)+gold_surf_hg', 1);
model.component('comp1').geom('geom1').feature('r1').set('pos', {'-(d+gap+gold_surf_wd)/2' '0'});
...
model.component('comp1').geom('geom1').feature('r3').set('pos', {'-(gold_surf_wd)/2' '0'});
...
model.component('comp1').geom('geom1').feature('r4').set('pos', {'-(gold_surf_wd)/2' '0'});
...
model.component('comp1').geom('geom1').feature('r5').set('size', {'pedestal/2' 'pedestal'});
model.component('comp1').geom('geom1').feature('r5').set('pos', {'-pedestal/4' '0'});
...
model.component('comp1').geom('geom1').feature('r6').set('pos', {'-(gold_surf_wd*1.5)/2' '0'});
...
model.component('comp1').physics('ewfd').feature('port1').set('Hampl', [0 0 1]);
...
model.component('comp1').physics('ewfd').feature('port2').set('Hampl', [0 0 1]);
...
model.component('comp1').material('mat1').propertyGroup('RefractiveIndex').set('n', {'na' '0' '0' '0' 'na' '0' '0' '0' 'na'});
model.component('comp1').material('mat1').propertyGroup('RefractiveIndex').set('ki', {'0' '0' '0' '0' '0' '0' '0' '0' '0'});
model.component('comp1').material('mat1').propertyGroup('RefractiveIndex').info('category').title([]);
model.component('comp1').material('mat1').propertyGroup('RefractiveIndex').info('category').body('Electromagnetic_models');
model.component('comp1').material('mat1').set('sys', 'none');
...
model.component('comp1').material('mat2').propertyGroup('RefractiveIndex').set('n', {'nb' '0' '0' '0' 'nb' '0' '0' '0' 'nb'});
model.component('comp1').material('mat2').propertyGroup('RefractiveIndex').set('ki', {'0' '0' '0' '0' '0' '0' '0' '0' '0'});
model.component('comp1').material('mat2').propertyGroup('RefractiveIndex').info('category').title([]);
model.component('comp1').material('mat2').propertyGroup('RefractiveIndex').info('category').body('Electromagnetic_models');
model.component('comp1').material('mat2').set('sys', 'none');
...
model.component('comp1').material('mat3').propertyGroup('RefractiveIndex').set('n', {'n_interp(1[1/m]*c_const/freq)' '0' '0' '0' 'n_interp(1[1/m]*c_const/freq)' '0' '0' '0' 'n_interp(1[1/m]*c_const/freq)'});
model.component('comp1').material('mat3').propertyGroup('RefractiveIndex').set('ki', {'k_interp(1[1/m]*c_const/freq)' '0' '0' '0' 'k_interp(1[1/m]*c_const/freq)' '0' '0' '0' 'k_interp(1[1/m]*c_const/freq)'});
model.component('comp1').material('mat3').propertyGroup('RefractiveIndex').addInput('frequency');
model.component('comp1').material('mat3').propertyGroup('RefractiveIndex').func.create('n_interp', 'Interpolation');
model.component('comp1').material('mat3').propertyGroup('RefractiveIndex').func('n_interp').set('table', {'2.0659999999999998E-7' '1.25223320824';  ...
...
model.component('comp1').material('mat3').propertyGroup('RefractiveIndex').func('n_interp').set('interp', 'piecewisecubic');
model.component('comp1').material('mat3').propertyGroup('RefractiveIndex').func('n_interp').set('allowrand', 'on');
model.component('comp1').material('mat3').propertyGroup('RefractiveIndex').func.create('k_interp', 'Interpolation');
model.component('comp1').material('mat3').propertyGroup('RefractiveIndex').func('k_interp').set('table', {'2.0659999999999998E-7' '1.98591656445';  ...
...
model.component('comp1').material('mat3').propertyGroup('RefractiveIndex').func('k_interp').set('interp', 'piecewisecubic');
model.component('comp1').material('mat3').propertyGroup('RefractiveIndex').func('k_interp').set('allowrand', 'on');
model.component('comp1').material('mat3').propertyGroup('RefractiveIndex').info('category').title([]);
model.component('comp1').material('mat3').propertyGroup('RefractiveIndex').info('category').body('Electromagnetic_models');
model.component('comp1').material('mat3').set('sys', 'none');
...
model.component('comp1').physics('ewfd').feature('port1').set('n', {'na' '0' '0' '0' 'na' '0' '0' '0' 'na'});
model.component('comp1').physics('ewfd').feature('port2').set('n', {'nb' '0' '0' '0' 'nb' '0' '0' '0' 'nb'});
...
model.sol('sol1').feature('s1').feature('p1').set('pname', {'lb'});
model.sol('sol1').feature('s1').feature('p1').set('plistarr', {'range(400[nm],1[nm],900[nm])'});
...
model.result('pg3').feature('lngr1').set('expr', 'if(root.comp1.ewfd.normJR_0==0,0,0.5*root.comp1.ewfd.JRIP_0*exp(j*PHASE)/root.comp1.ewfd.normJR_0)+(0)');
model.result('pg3').feature('lngr1').set('xdata', 'expr');
model.result('pg3').feature('lngr1').set('xdataexpr', 'if(root.comp1.ewfd.normJR_0==0,0,0.5*root.comp1.ewfd.JROOP_0*exp(j*PHASE)/root.comp1.ewfd.normJR_0)+(0)');
...
model.result('pg3').feature('ann1').set('posexpr', {'0' '0'});
model.result('pg3').create('lngr2', 'LineGraph');
model.result('pg3').feature('lngr2').set('expr', 'if(root.comp1.ewfd.normJT_0==0,0,0.5*root.comp1.ewfd.JTIP_0*exp(j*PHASE)/root.comp1.ewfd.normJT_0)+(0)');
model.result('pg3').feature('lngr2').set('xdata', 'expr');
model.result('pg3').feature('lngr2').set('xdataexpr', 'if(root.comp1.ewfd.normJT_0==0,0,0.5*root.comp1.ewfd.JTOOP_0*exp(j*PHASE)/root.comp1.ewfd.normJT_0)+(0)');
